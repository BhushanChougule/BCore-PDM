...
\- REASON-FOR-CHANGE: a line under the pickers shows each release's stored reason ("Reason — From: {x}   To: {y}"; "—" when blank) so the "what changed" sits next to the "why" (the ECO pattern). From AssemblyBaseline.Reason.
